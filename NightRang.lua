...
send(chat,msg.id_,"\n•تم رفع الملف بنجاح وتفعيل المجموعات\n• ورفع {الامالكين الاساسين ; والمالكين ; والمدراء; والادمنيه} بنجاح")   
end
...
send(msg.chat_id_,0, "•عذرا يا ⇠ ["..data.first_name_.."](t.me/deeeeeeeei)\n• الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
Delete_Message(msg.chat_id_,{[0] = msg.id_})       
return false   
...
CmdStart = '\n• اهلا بك عزيزي \n انا بوت اسمي '..(redis:get(bot_id.."NightRang:Redis:Name:Bot") or "ماكس")..''..
'\n• إختصاصي حماية المجموعات'..
'\nمن ألسبام والتوجيه والتكرار واكثر ، جميع ردود البوت سعوديه  ...'..
...
if not Constructor(msg) then
return send(msg.chat_id_,msg.id_,'*• عذرآ هاذا الامر يخص : المالكين فقط *')
end
redis:set(bot_id.."NightRang:Add:Validity:Users"..msg.chat_id_..result.sender_user_id_,text:match("رفع (.*)"))  
...
return false end
if text == 'حذف رد المالك الاساسي' and Owner(msg) then
local channelchek = https.request('https://devstorm.ml/ch/?id='..msg.sender_user_id_)
local chekjoine = JSON.decode(channelchek)
if chekjoine.Ch_Member.Ch_info ~= true then
send(msg.chat_id_, msg.id_,'• عليك الاشتراك بقناة السورس \n • قناة السورس - [@deeeeeeeei] ') 
...
send(msg.chat_id_, msg.id_,"• تم حذف رد المالك الاساسي ")
return false end
if text == 'حذف رد المالك' and Owner(msg) then
local channelchek = https.request('https://devstorm.ml/ch/?id='..msg.sender_user_id_)
local chekjoine = JSON.decode(channelchek)
if chekjoine.Ch_Member.Ch_info ~= true then
send(msg.chat_id_, msg.id_,'• عليك الاشتراك بقناة السورس \n • قناة السورس - [@deeeeeeeei] ') 
...
send(msg.chat_id_, msg.id_,"• تم حذف رد المالك ")
return false end
